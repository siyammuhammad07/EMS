...
public class DisplayAllEmps_jFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Number of people in the table :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        model = new DefaultTableModel(new Object[] {"Status","Emp Num","First Name", "Last Name", "Salary", "Work Location",
                                                   "Deduct Rate", "Hourly Wage", "Hours Per Week", "Weeks Per Year"},numInHT);
            ...
            for (int i = 0; i < mainHT.buckets.length; i++) {
                for (int j = 0; j < mainHT.buckets[i].size(); j++) {
                    ...
                    if (theEmp instanceof FTE) {
                        ...
                        model.setValueAt(theEmp.getYearlySalary(),empCounter,4);
                        //5
                        model.setValueAt(theEmp.getDeductRate(), empCounter,6);
                    ...
                    if (theEmp instanceof PTE) {
                        ...
                        model.setValueAt(theEmp.getFirstName(), empCounter, 2);
                        model.setValueAt(theEmp.getLastName(), empCounter, 3);
                        model.setValueAt("N/A",empCounter,4);
                        // 5
                        model.setValueAt(theEmp.getDeductRate(),empCounter,6);
                        model.setValueAt(theEmp.getHourlyWage(), empCounter, 7);
                        model.setValueAt(theEmp.getHoursPerWeek(), empCounter, 8); 
                        model.setValueAt(theEmp.getWeeksPerYear(), empCounter, 9); 
                   }
                }
